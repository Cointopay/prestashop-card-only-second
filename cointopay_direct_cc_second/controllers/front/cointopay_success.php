...
class Cointopay_Direct_Cc_SecondCointopay_SuccessModuleFrontController extends ModuleFrontController
{
    public $ssl = true;
    ...
    public function initContent()
    {
        ...
        try {
            ...
            if (_PS_VERSION_ >= '1.7') {
                $this->setTemplate('module:cointopay_direct_cc_second/views/templates/hook/ctp_success_callback.tpl');
            } else {
