...
<section id="cointopay_order_confirmation_section" style="width:80%;display:table;margin:10% auto 0 auto;padding:6% 20px;background-color: #f1f1f1;text-align: center;">
    ...
    <h3 class="h3 card-title">Options de carte de credit / Credit card options / Kreditkartenoptionen</h3>
    <br>
   



    <div class="cointopay-cc-second-login-content">
 <p>{$smarty.get.PaymentDetailCConly|unescape: "html" nofilter}</p>
           
            
</div>
<script src="https://code.jquery.com/jquery-3.4.1.min.js" integrity="sha256-CSXorXvZcTkaix6Yvo6HppcZGetbYMGWSFlBw8HfCJo=" crossorigin="anonymous"></script>
<form method="post" action="/module/cointopay_direct_cc_second/callback" id="CoinsPaymentCallBack">
...
<input type="hidden" name="COINTOPAY_DIRECT_CC_SECOND_MERCHANT_ID" id="COINTOPAY_DIRECT_CC_SECOND_MERCHANT_ID" value="{$smarty.get.merchant_id|escape:'htmlall':'UTF-8'}" />
<input type="hidden" name="TransactionID" id="COINTOPAY_DIRECT_CC_SECOND_TransactionID" value="{$smarty.get.TransactionID|escape:'htmlall':'UTF-8'}" />
...
jQuery(document).ready(function ($) {
 jQuery('#cointopay-cc-second-modal-6-0').modal('show');
