...
<div id="Information" class="tabcontent">
	<div class="wrapper">
	  <img src="../modules/cointopay_direct_cc_second/views/img/invoice.png" style="float:right;"/>
	  <h2 class="cointopay-cc-second-information-header">Accept Bitcoin, Litecoin, Ethereum and other digital currencies on your PrestaShop store with Cointopay</h2><br/>
	  ...
	  <p>
	  	<ul>
	  		<li>Install the Cointopay Direct CC Second module on PrestaShop</li>
	  ...
	  <img src="../modules/cointopay_direct_cc_second/views/img/currencies.png" style="float:right;"/>
	  <p class="sign-up"><br/>
